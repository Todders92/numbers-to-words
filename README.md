...
#### _A console application converting a string of numbers to words_

#### By _**Todd Walraven**_

## Description

_This Application has the user enter a number. the logic of the program takes the inputted number and translates it into the word equivilent of it (example: 234 turns into two hundred thirty four)_
